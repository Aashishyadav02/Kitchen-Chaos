...
public class Player : MonoBehaviour ,IKitchenObjectParent
{
  ...
  private void Start()
  {
      gameInput.OnIntreractAction += GameInput_OnInteractAction;
      gameInput.OnIntreractAlternateAction += GameInput_OnInteractAlternateAction;
  }
  ...
  private void Update()
   ...
   public void SetKitchenObject(KitchenObject kitchenObject)
   {
       ...
       {
           OnPickedSomething?.Invoke(this, new EventArgs());
       }
   }
